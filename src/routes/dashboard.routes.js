...
import {
  ...
  getCycleSummaryById,
} from '../controllers/summary/cycleSummary.controller.js';
 ...
 *       On `done`, response includes a `summaryId` for later retrieval/export.
 *
...
/**
 * @swagger
 * /api/v1/dashboard/cycle-summary/history:
 *   get:
 *     summary: Get cycle summary generation history for a user
 *     description: |
 *       Returns all stored cycle summaries generated by the user identified by `x-user-email`.
 ...
 *         schema:
 *           type: string
 *         description: User email used to fetch summary history
 *     responses:
 *       200:
 *         description: Summary history fetched successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *         description: Server error
 */
router.get('/cycle-summary/history', requireStatsScope, getCycleSummaryHistory);

/**
 * @swagger
 * /api/v1/dashboard/cycle-summary/{summaryId}:
 *   get:
 *     summary: Get stored cycle summary by summaryId
 *     description: |
 *       Fetches a previously generated cycle summary from MongoDB.
 *       Use `?export=true` to download the stored summary as a formatted PDF report.
 *     tags: [Dashboard - AI Summary]
 *     parameters:
 *       - in: path
 *         name: summaryId
 ...
 *         schema:
 *           type: string
 *         description: Stored cycle summary ObjectId
 *       - in: query
 *         name: export
 *         schema:
 *           type: string
 *           enum: ['true', 'false']
 *           default: 'false'
 *         description: Download the stored summary as PDF when set to true
 *     responses:
 *       200:
 *         description: Stored cycle summary fetched successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *         description: Access denied
 *       404:
 *         description: Cycle summary not found
 *       500:
 *         description: Server error
 */
router.get('/cycle-summary/:summaryId', requireStatsScope, getCycleSummaryById);
